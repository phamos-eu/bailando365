...
class DanceEvent(WebsiteGenerator):
    website = frappe._dict(
        ...
        template="bailando365/bailando365/doctype/dance_event/templates/dance_event.html",
        row_template="bailando365/bailando365/doctype/dance_event/templates/dance_event_row.html",
    )
